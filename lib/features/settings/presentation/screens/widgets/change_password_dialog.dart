  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        if (msg.contains('wrong-password')) msg = 'Current password is incorrect.';
        if (msg.contains('weak-password')) msg = 'New password is too weak.';
        ScaffoldMessenger.of(context).showSnackBar(
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      TextFormField(
        ...
        decoration: InputDecoration(
          prefixIcon: Icon(Icons.lock_outlined, size: 20, color: Theme.of(context).colorScheme.onSurfaceVariant),
