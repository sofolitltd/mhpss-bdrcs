            ...
            child: MaxWidthContainer(
              child: CustomScrollView(
                ...
                slivers: [
                  ...
                  const SliverToBoxAdapter(child: SectionHeader(title: 'MHPSS Basics')),
                  const SliverToBoxAdapter(child: SupportSection()),
                  const SliverToBoxAdapter(child: SizedBox(height: AppSpacing.lg)),
                  SliverToBoxAdapter(child: SignOutSection(ref: ref)),
                  const SliverToBoxAdapter(child: SizedBox(height: AppSpacing.xxl)),
                  const SliverToBoxAdapter(child: SectionHeader(title: 'Developer')),
                  const SliverToBoxAdapter(child: DeveloperInfo()),
                  const SliverToBoxAdapter(child: SizedBox(height: AppSpacing.xxl)),
                ],
              ),
            ),
